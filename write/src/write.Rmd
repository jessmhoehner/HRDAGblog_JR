...
I start with the import task. In the input folder I include the two files I'd like to examine. These are the two datasets with cases of the potential epidemic. 
...
files <- list(fludata1 = here: here("clean/import/flu_data_1_122219.csv"), 
              fludata2 = here: here("clean/import/flu_data_2_122219.csv"), 
              cleanflu1 = here: here: here("clean/output/flu1.csv"),
              cleanflu2 = here: here: here("clean/output/flu2.csv"))
#test
