...
files <- list(input1=here::here("HRDAG/HRDAGblog_JR/clean/output/deaths1.csv"),
              input2=here::here("HRDAG/HRDAGblog_JR/clean/output/deaths2.csv"))
...
res2 <- poisson.test(mu2post, 1, mu2pre, alternative = "g", conf.level = 0.95)
```
